  ...
  <div :class="$style.authPage">
    <div :class="$style.authContainer">
      <div :class="$style.authHeader">
        ...
        <p :class="$style.subtitle">Join Streamly today</p>
      </div>

      <form :class="$style.authForm" @submit.prevent="handleSignUp">
        ...
        <div :class="$style.formGroup">
          <label for="displayName" :class="$style.label">Display Name</label>
          <input
            id="displayName"
      ...
      <div :class="$style.authFooter">
        <p>
          ...
          <nuxt-link :to="{ name: 'auth-signin' }" :class="$style.link">
            Sign in
          </nuxt-link>
        </p>
      </div>
