<template>
  <footer :class="$style.footer">
    <p>&copy; {{ new Date().getFullYear() }} Streamly. All rights reserved. <a target="_blank" href="https://streamly.app/privacy" rel="noopener">Privacy Policy</a>.</p>
    <p>Stream your favorite movies and TV shows, powered by <a target="_blank" href="https://www.themoviedb.org/" rel="noopener">TMDb</a>.</p>

    <ul class="nolist">
      <li>
        <a
          href="https://twitter.com/streamlyapp"
          target="_blank"
          aria-label="Link to Streamly Twitter account"
          rel="noopener">
      ...
      <li>
        <a
          href="https://github.com/streamlyapp"
          target="_blank"
          aria-label="Link to Streamly GitHub account"
          rel="noopener">
          <!-- eslint-disable-next-line -->
      ...
      <li>
        <a
          href="https://www.linkedin.com/company/streamly"
          target="_blank"
          aria-label="Link to Streamly LinkedIn account"
          rel="noopener">
          <!-- eslint-disable-next-line -->
      ...
      <li>
        <a
          href="mailto:hello@streamly.app"
          aria-label="Link to Streamly Email"
          rel="noopener">
          <!-- eslint-disable-next-line -->
